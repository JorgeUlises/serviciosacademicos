...
if($_REQUEST["modulo"]!=51&&$_REQUEST["modulo"]!=52) 
	echo "<div style='text-align: center;'><h3>".utf8_encode($this->lenguaje->getCadena("ulTabs1"))."</h3><br></div>";
else
	echo "<div style='text-align: center;'><h3>".utf8_encode($this->lenguaje->getCadena("ulTabs12"))."</h3><br></div>";
...
echo 'a1.href = "#tabs-1";';
echo 'a1.innerHTML = "'.utf8_encode($this->lenguaje->getCadena("ulTabs1")).'";';
echo 'li1.appendChild(a1);';
echo 'var li2 = document.createElement("li");';
echo 'var a2 = document.createElement("a");';
echo 'a2.href = "#tabs-2";';
if($_REQUEST["modulo"] == 68) echo 'a2.innerHTML = "'.utf8_encode($this->lenguaje->getCadena("ulTabs2")).'";';
if($_REQUEST["modulo"] == 109) echo 'a2.innerHTML = "'.utf8_encode($this->lenguaje->getCadena("ulTabs22")).'";';
