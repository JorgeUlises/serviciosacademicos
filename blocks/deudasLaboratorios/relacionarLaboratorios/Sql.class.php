...
class SqlrelacionarLaboratorios extends sql {
	...
	function cadena_sql($tipo,$variable="") {
		...
		switch($tipo) {
			...
			case "consultarUsuarioLaboratorio":
				$cadena_sql=" SELECT A.id_usuario_laboratorio AS \"id\", A.id_usuario AS \"Identificacion\" , B.cpto_nombre AS \"Nombre Laboratorio\", DECODE(A.estado, 0, 'Inactivo',1, 'Activo') \"Estado\" ";
				$cadena_sql.=" FROM USUARIO_LABORATORIO A, ACCONCEPTO B ";
				$cadena_sql.=" WHERE B.cpto_cod = A.cpto_cod  ORDER BY 2";
				break;
