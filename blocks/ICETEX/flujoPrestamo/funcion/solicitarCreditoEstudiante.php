...
$cuerpo ='El estudiante de código '.$_REQUEST['valorConsulta'].'('.$identificacion.') Ha realizado una solicitud de credito ICETEX<br>';
$cuerpo .=' Verificar si tiene el crédito aprobado y registrarlo en el sistema académico';
